#[doc = "Reader of register PL2_PLMASK_HI"]
pub type R = crate::R<u32, super::PL2_PLMASK_HI>;
#[doc = "Writer for register PL2_PLMASK_HI"]
pub type W = crate::W<u32, super::PL2_PLMASK_HI>;
#[doc = "Register PL2_PLMASK_HI `reset()`'s with value 0"]
impl crate::ResetValue for super::PL2_PLMASK_HI {
    type Type = u32;
    #[inline(always)]
