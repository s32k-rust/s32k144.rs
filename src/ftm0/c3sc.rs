#[doc = "Reader of register C3SC"]
pub type R = crate::R<u32, super::C3SC>;
#[doc = "Writer for register C3SC"]
pub type W = crate::W<u32, super::C3SC>;
#[doc = "Register C3SC `reset()`'s with value 0"]
impl crate::ResetValue for super::C3SC {
    type Type = u32;
    #[inline(always)]
