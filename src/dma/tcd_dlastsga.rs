#[doc = "Reader of register TCD%s_DLASTSGA"]
pub type R = crate::R<u32, super::TCD_DLASTSGA>;
#[doc = "Writer for register TCD%s_DLASTSGA"]
pub type W = crate::W<u32, super::TCD_DLASTSGA>;
#[doc = "Register TCD%s_DLASTSGA `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD_DLASTSGA {
    type Type = u32;
    #[inline(always)]
