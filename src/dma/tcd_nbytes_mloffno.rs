#[doc = "Reader of register TCD%s_NBYTES_MLOFFNO"]
pub type R = crate::R<u32, super::TCD_NBYTES_MLOFFNO>;
#[doc = "Writer for register TCD%s_NBYTES_MLOFFNO"]
pub type W = crate::W<u32, super::TCD_NBYTES_MLOFFNO>;
#[doc = "Register TCD%s_NBYTES_MLOFFNO `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD_NBYTES_MLOFFNO {
    type Type = u32;
    #[inline(always)]
