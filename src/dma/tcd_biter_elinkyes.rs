#[doc = "Reader of register TCD%s_BITER_ELINKYES"]
pub type R = crate::R<u16, super::TCD_BITER_ELINKYES>;
#[doc = "Writer for register TCD%s_BITER_ELINKYES"]
pub type W = crate::W<u16, super::TCD_BITER_ELINKYES>;
#[doc = "Register TCD%s_BITER_ELINKYES `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD_BITER_ELINKYES {
    type Type = u16;
    #[inline(always)]
