#[doc = "Reader of register TCD%s_DADDR"]
pub type R = crate::R<u32, super::TCD_DADDR>;
#[doc = "Writer for register TCD%s_DADDR"]
pub type W = crate::W<u32, super::TCD_DADDR>;
#[doc = "Register TCD%s_DADDR `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD_DADDR {
    type Type = u32;
    #[inline(always)]
