#[doc = "Reader of register TCD%s_SLAST"]
pub type R = crate::R<u32, super::TCD_SLAST>;
#[doc = "Writer for register TCD%s_SLAST"]
pub type W = crate::W<u32, super::TCD_SLAST>;
#[doc = "Register TCD%s_SLAST `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD_SLAST {
    type Type = u32;
    #[inline(always)]
