#[doc = "Reader of register SHIFTBUFBBS1"]
pub type R = crate::R<u32, super::SHIFTBUFBBS1>;
#[doc = "Writer for register SHIFTBUFBBS1"]
pub type W = crate::W<u32, super::SHIFTBUFBBS1>;
#[doc = "Register SHIFTBUFBBS1 `reset()`'s with value 0"]
impl crate::ResetValue for super::SHIFTBUFBBS1 {
    type Type = u32;
    #[inline(always)]
