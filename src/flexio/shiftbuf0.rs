#[doc = "Reader of register SHIFTBUF0"]
pub type R = crate::R<u32, super::SHIFTBUF0>;
#[doc = "Writer for register SHIFTBUF0"]
pub type W = crate::W<u32, super::SHIFTBUF0>;
#[doc = "Register SHIFTBUF0 `reset()`'s with value 0"]
impl crate::ResetValue for super::SHIFTBUF0 {
    type Type = u32;
    #[inline(always)]
