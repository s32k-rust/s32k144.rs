#[doc = "Reader of register SHIFTBUFBYS3"]
pub type R = crate::R<u32, super::SHIFTBUFBYS3>;
#[doc = "Writer for register SHIFTBUFBYS3"]
pub type W = crate::W<u32, super::SHIFTBUFBYS3>;
#[doc = "Register SHIFTBUFBYS3 `reset()`'s with value 0"]
impl crate::ResetValue for super::SHIFTBUFBYS3 {
    type Type = u32;
    #[inline(always)]
