#[doc = "Reader of register SHIFTBUFBBS0"]
pub type R = crate::R<u32, super::SHIFTBUFBBS0>;
#[doc = "Writer for register SHIFTBUFBBS0"]
pub type W = crate::W<u32, super::SHIFTBUFBBS0>;
#[doc = "Register SHIFTBUFBBS0 `reset()`'s with value 0"]
impl crate::ResetValue for super::SHIFTBUFBBS0 {
    type Type = u32;
    #[inline(always)]
