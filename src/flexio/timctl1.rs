#[doc = "Reader of register TIMCTL1"]
pub type R = crate::R<u32, super::TIMCTL1>;
#[doc = "Writer for register TIMCTL1"]
pub type W = crate::W<u32, super::TIMCTL1>;
#[doc = "Register TIMCTL1 `reset()`'s with value 0"]
impl crate::ResetValue for super::TIMCTL1 {
    type Type = u32;
    #[inline(always)]
