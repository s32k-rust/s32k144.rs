#[doc = "Reader of register SHIFTBUFBIS3"]
pub type R = crate::R<u32, super::SHIFTBUFBIS3>;
#[doc = "Writer for register SHIFTBUFBIS3"]
pub type W = crate::W<u32, super::SHIFTBUFBIS3>;
#[doc = "Register SHIFTBUFBIS3 `reset()`'s with value 0"]
impl crate::ResetValue for super::SHIFTBUFBIS3 {
    type Type = u32;
    #[inline(always)]
