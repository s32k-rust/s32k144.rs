#[doc = "Reader of register SHIFTBUF1"]
pub type R = crate::R<u32, super::SHIFTBUF1>;
#[doc = "Writer for register SHIFTBUF1"]
pub type W = crate::W<u32, super::SHIFTBUF1>;
#[doc = "Register SHIFTBUF1 `reset()`'s with value 0"]
impl crate::ResetValue for super::SHIFTBUF1 {
    type Type = u32;
    #[inline(always)]
