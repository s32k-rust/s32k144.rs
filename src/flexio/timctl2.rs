#[doc = "Reader of register TIMCTL2"]
pub type R = crate::R<u32, super::TIMCTL2>;
#[doc = "Writer for register TIMCTL2"]
pub type W = crate::W<u32, super::TIMCTL2>;
#[doc = "Register TIMCTL2 `reset()`'s with value 0"]
impl crate::ResetValue for super::TIMCTL2 {
    type Type = u32;
    #[inline(always)]
