#[doc = "Reader of register TIMCTL0"]
pub type R = crate::R<u32, super::TIMCTL0>;
#[doc = "Writer for register TIMCTL0"]
pub type W = crate::W<u32, super::TIMCTL0>;
#[doc = "Register TIMCTL0 `reset()`'s with value 0"]
impl crate::ResetValue for super::TIMCTL0 {
    type Type = u32;
    #[inline(always)]
