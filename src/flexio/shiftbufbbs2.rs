#[doc = "Reader of register SHIFTBUFBBS2"]
pub type R = crate::R<u32, super::SHIFTBUFBBS2>;
#[doc = "Writer for register SHIFTBUFBBS2"]
pub type W = crate::W<u32, super::SHIFTBUFBBS2>;
#[doc = "Register SHIFTBUFBBS2 `reset()`'s with value 0"]
impl crate::ResetValue for super::SHIFTBUFBBS2 {
    type Type = u32;
    #[inline(always)]
