#[doc = "Reader of register SHIFTBUF3"]
pub type R = crate::R<u32, super::SHIFTBUF3>;
#[doc = "Writer for register SHIFTBUF3"]
pub type W = crate::W<u32, super::SHIFTBUF3>;
#[doc = "Register SHIFTBUF3 `reset()`'s with value 0"]
impl crate::ResetValue for super::SHIFTBUF3 {
    type Type = u32;
    #[inline(always)]
