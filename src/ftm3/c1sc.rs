#[doc = "Reader of register C1SC"]
pub type R = crate::R<u32, super::C1SC>;
#[doc = "Writer for register C1SC"]
pub type W = crate::W<u32, super::C1SC>;
#[doc = "Register C1SC `reset()`'s with value 0"]
impl crate::ResetValue for super::C1SC {
    type Type = u32;
    #[inline(always)]
