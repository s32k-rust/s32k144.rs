#[doc = "Reader of register C6SC"]
pub type R = crate::R<u32, super::C6SC>;
#[doc = "Writer for register C6SC"]
pub type W = crate::W<u32, super::C6SC>;
#[doc = "Register C6SC `reset()`'s with value 0"]
impl crate::ResetValue for super::C6SC {
    type Type = u32;
    #[inline(always)]
