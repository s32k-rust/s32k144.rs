#[doc = "Reader of register C2SC"]
pub type R = crate::R<u32, super::C2SC>;
#[doc = "Writer for register C2SC"]
pub type W = crate::W<u32, super::C2SC>;
#[doc = "Register C2SC `reset()`'s with value 0"]
impl crate::ResetValue for super::C2SC {
    type Type = u32;
    #[inline(always)]
