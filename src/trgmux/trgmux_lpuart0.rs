#[doc = "Reader of register TRGMUX_LPUART0"]
pub type R = crate::R<u32, super::TRGMUX_LPUART0>;
#[doc = "Writer for register TRGMUX_LPUART0"]
pub type W = crate::W<u32, super::TRGMUX_LPUART0>;
#[doc = "Register TRGMUX_LPUART0 `reset()`'s with value 0"]
impl crate::ResetValue for super::TRGMUX_LPUART0 {
    type Type = u32;
    #[inline(always)]
