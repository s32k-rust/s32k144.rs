#[doc = "Reader of register TRGMUX_LPUART1"]
pub type R = crate::R<u32, super::TRGMUX_LPUART1>;
#[doc = "Writer for register TRGMUX_LPUART1"]
pub type W = crate::W<u32, super::TRGMUX_LPUART1>;
#[doc = "Register TRGMUX_LPUART1 `reset()`'s with value 0"]
impl crate::ResetValue for super::TRGMUX_LPUART1 {
    type Type = u32;
    #[inline(always)]
