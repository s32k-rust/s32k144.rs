#[doc = "Reader of register TRGMUX_LPSPI0"]
pub type R = crate::R<u32, super::TRGMUX_LPSPI0>;
#[doc = "Writer for register TRGMUX_LPSPI0"]
pub type W = crate::W<u32, super::TRGMUX_LPSPI0>;
#[doc = "Register TRGMUX_LPSPI0 `reset()`'s with value 0"]
impl crate::ResetValue for super::TRGMUX_LPSPI0 {
    type Type = u32;
    #[inline(always)]
