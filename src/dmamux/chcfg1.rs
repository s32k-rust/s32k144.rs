...
pub type R = crate::R<u8, super::CHCFG1>;
#[doc = "Writer for register CHCFG1"]
pub type W = crate::W<u8, super::CHCFG1>;
#[doc = "Register CHCFG1 `reset()`'s with value 0"]
impl crate::ResetValue for super::CHCFG1 {
    type Type = u8;
    #[inline(always)]
