#[doc = "Reader of register CHCFG6"]
pub type R = crate::R<u8, super::CHCFG6>;
#[doc = "Writer for register CHCFG6"]
pub type W = crate::W<u8, super::CHCFG6>;
#[doc = "Register CHCFG6 `reset()`'s with value 0"]
impl crate::ResetValue for super::CHCFG6 {
    type Type = u8;
    #[inline(always)]
