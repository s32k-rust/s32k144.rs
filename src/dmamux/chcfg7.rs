#[doc = "Reader of register CHCFG7"]
pub type R = crate::R<u8, super::CHCFG7>;
#[doc = "Writer for register CHCFG7"]
pub type W = crate::W<u8, super::CHCFG7>;
#[doc = "Register CHCFG7 `reset()`'s with value 0"]
impl crate::ResetValue for super::CHCFG7 {
    type Type = u8;
    #[inline(always)]
