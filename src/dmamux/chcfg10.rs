#[doc = "Reader of register CHCFG10"]
pub type R = crate::R<u8, super::CHCFG10>;
#[doc = "Writer for register CHCFG10"]
pub type W = crate::W<u8, super::CHCFG10>;
#[doc = "Register CHCFG10 `reset()`'s with value 0"]
impl crate::ResetValue for super::CHCFG10 {
    type Type = u8;
    #[inline(always)]
