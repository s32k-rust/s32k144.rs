#[doc = "Reader of register CHCFG2"]
pub type R = crate::R<u8, super::CHCFG2>;
#[doc = "Writer for register CHCFG2"]
pub type W = crate::W<u8, super::CHCFG2>;
#[doc = "Register CHCFG2 `reset()`'s with value 0"]
impl crate::ResetValue for super::CHCFG2 {
    type Type = u8;
    #[inline(always)]
