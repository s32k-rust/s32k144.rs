#[doc = "Reader of register CHCFG0"]
pub type R = crate::R<u8, super::CHCFG0>;
#[doc = "Writer for register CHCFG0"]
pub type W = crate::W<u8, super::CHCFG0>;
#[doc = "Register CHCFG0 `reset()`'s with value 0"]
impl crate::ResetValue for super::CHCFG0 {
    type Type = u8;
    #[inline(always)]
