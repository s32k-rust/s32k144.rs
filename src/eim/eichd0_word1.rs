#[doc = "Reader of register EICHD0_WORD1"]
pub type R = crate::R<u32, super::EICHD0_WORD1>;
#[doc = "Writer for register EICHD0_WORD1"]
pub type W = crate::W<u32, super::EICHD0_WORD1>;
#[doc = "Register EICHD0_WORD1 `reset()`'s with value 0"]
impl crate::ResetValue for super::EICHD0_WORD1 {
    type Type = u32;
    #[inline(always)]
