#[doc = "Reader of register PCR1"]
pub type R = crate::R<u32, super::PCR1>;
#[doc = "Writer for register PCR1"]
pub type W = crate::W<u32, super::PCR1>;
#[doc = "Register PCR1 `reset()`'s with value 0x03"]
impl crate::ResetValue for super::PCR1 {
    type Type = u32;
    #[inline(always)]
