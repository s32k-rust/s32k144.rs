#[doc = "Reader of register C0SC"]
pub type R = crate::R<u32, super::C0SC>;
#[doc = "Writer for register C0SC"]
pub type W = crate::W<u32, super::C0SC>;
#[doc = "Register C0SC `reset()`'s with value 0"]
impl crate::ResetValue for super::C0SC {
    type Type = u32;
    #[inline(always)]
