#[doc = "Reader of register C4SC"]
pub type R = crate::R<u32, super::C4SC>;
#[doc = "Writer for register C4SC"]
pub type W = crate::W<u32, super::C4SC>;
#[doc = "Register C4SC `reset()`'s with value 0"]
impl crate::ResetValue for super::C4SC {
    type Type = u32;
    #[inline(always)]
