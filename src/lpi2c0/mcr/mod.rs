...
pub enum MENR {
    #[doc = "Master logic is disabled."] _0,
    #[doc = "Master logic is enabled."] _1,
}
impl MENR {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DOZENR {
    #[doc = "Master is enabled in Doze mode."] _0,
    #[doc = "Master is disabled in Doze mode."] _1,
}
impl DOZENR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    #[inline]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DBGENR {
    #[doc = "Master is disabled in debug mode."] _0,
    #[doc = "Master is enabled in debug mode."] _1,
}
impl DBGENR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    #[inline]
