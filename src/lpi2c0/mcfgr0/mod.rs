...
pub enum HRENR {
    #[doc = "Host request input is disabled."] _0,
    #[doc = "Host request input is enabled."] _1,
}
impl HRENR {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum HRSELR {
    #[doc = "Host request input is pin HREQ."] _0,
...
pub enum RDMOR {
    ...
    #[doc = "Received data is discarded unless the RMF is set."] _1,
}
impl RDMOR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    #[inline]
