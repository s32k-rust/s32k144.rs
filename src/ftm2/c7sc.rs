#[doc = "Reader of register C7SC"]
pub type R = crate::R<u32, super::C7SC>;
#[doc = "Writer for register C7SC"]
pub type W = crate::W<u32, super::C7SC>;
#[doc = "Register C7SC `reset()`'s with value 0"]
impl crate::ResetValue for super::C7SC {
    type Type = u32;
    #[inline(always)]
