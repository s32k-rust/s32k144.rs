#[doc = "Reader of register PCC_PORTD"]
pub type R = crate::R<u32, super::PCC_PORTD>;
#[doc = "Writer for register PCC_PORTD"]
pub type W = crate::W<u32, super::PCC_PORTD>;
#[doc = "Register PCC_PORTD `reset()`'s with value 0x8000_0000"]
impl crate::ResetValue for super::PCC_PORTD {
    type Type = u32;
    #[inline(always)]
