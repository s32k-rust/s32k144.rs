#[doc = "Reader of register PCC_LPTMR0"]
pub type R = crate::R<u32, super::PCC_LPTMR0>;
#[doc = "Writer for register PCC_LPTMR0"]
pub type W = crate::W<u32, super::PCC_LPTMR0>;
#[doc = "Register PCC_LPTMR0 `reset()`'s with value 0x8000_0000"]
impl crate::ResetValue for super::PCC_LPTMR0 {
    type Type = u32;
    #[inline(always)]
